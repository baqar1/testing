            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('course.update', ['id' => $course->id]) }}">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="courseTypeId"  autofocus>
                                        ...
                                        @foreach($courseTypes as $courseType)
                                            ...
                                            @if($courseType->id == $course->course_type_id)
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4" cols="50">{{ $course->description }}</textarea>
