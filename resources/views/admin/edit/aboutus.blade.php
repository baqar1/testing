            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('aboutus.update', ['aboutus_id' => $aboutUs->id]) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="mission" name="mission" rows="4" cols="50">{{ $aboutUs->mission }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('history') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="history" name="history" rows="4" cols="50">{{ $aboutUs->history }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('other_description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="other_description" name="other_description" rows="4" cols="50">{{ $aboutUs->other_description }}</textarea>
