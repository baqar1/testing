            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('outdoorClass.update', ['id' => $outdoorClass->id]) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="class_name" type="text" class="form-control" name="class_name" value="{{ $outdoorClass->class_name }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('place') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="place" name="place" rows="4" cols="50">{{ $outdoorClass->place }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('other_description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="other_description" name="other_description" rows="4" cols="50">{{ $outdoorClass->other_description }}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('contactInfo') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea class="form-control" id="contactInfo" name="contactInfo" rows="4" cols="50">{{ $outdoorClass->contactInfo }}</textarea>
