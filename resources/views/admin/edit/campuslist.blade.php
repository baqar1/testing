                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($campuses as $campus)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href=" {{ route('campus.edit', ['campus_id' => $campus->id]) }}"><button type="button" class="btn btn-success">Edit</button></a>
                                        <form action="{{ route('campus.delete', ['campus_id' => $campus->id]) }}" method="POST">
                                            {{ csrf_field() }}
